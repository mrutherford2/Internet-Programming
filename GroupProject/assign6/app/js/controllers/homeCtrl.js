'use strict';
app.controller('homeCtrl', ['$scope','loginService', '$http', 'sessionService', 'filterFilter', '$pusher', function($scope,loginService, $http, sessionService, filterFilter, $pusher) {

  // var client = new Pusher('2f360f39df4aa6cf9bd6');
  ...
  // });
  // generalChannel.bind('drop', callback);
